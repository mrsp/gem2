...
figure
plot(gyrof(start:endl,3),'black','linewidth',1);
hold on
plot(-rwf_est(start:endl,3),'red');
hold on
plot(-lwf_est(start:endl,3),'green');
...
figure
plot(accf(start:endl,2),'black');
hold on
plot(acc_LLeg_est(start:endl,2),'green');
hold on
plot(acc_RLeg_est(start:endl,2),'red');
%% Save Data
